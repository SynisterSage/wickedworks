  ...
  return (
    <div className="group relative flex flex-col sm:flex-row gap-6 p-5 bg-bg-secondary border border-border-color items-center transition-all duration-500 hover:border-neonRed/30 animate-in slide-in-from-bottom-2 overflow-hidden shadow-2xl">
      ...
      <div className="flex-1 flex flex-col md:flex-row md:items-center justify-between gap-6 min-w-0 w-full">
        <div className="min-w-0 text-left cursor-pointer flex-1" onClick={onViewProduct}>
          <div className="flex items-center gap-3 mb-2">
             <span className="text-[8px] font-black uppercase tracking-[0.4em] text-text-secondary bg-bg-contrast-05 px-2 py-1">
              {product.category}
            </span>
        ...
        <div className="flex items-center justify-between sm:justify-end gap-6 md:gap-12 flex-shrink-0 w-full sm:w-auto">
...
const SavedPage: React.FC<SavedPageProps> = ({ products, onViewProduct, onToggleSave, onNavigateHome, onNavigate }) => {
