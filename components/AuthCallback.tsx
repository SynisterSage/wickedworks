  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-bg-primary">
      <div className="text-center">
        {error ? (
          <>
            <h1 className="text-2xl font-bold text-neonRed mb-4">Authentication Error</h1>
            <p className="text-gray-600 dark:text-white/60">{error}</p>
            <p className="text-gray-400 dark:text-white/40 mt-2">Redirecting to home...</p>
          </>
        ) : (
          <>
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-neonRed mx-auto mb-4"></div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Logging you in...</h1>
            <p className="text-gray-600 dark:text-white/60">Please wait while we complete authentication</p>
          </>
        )}
      </div>
    </div>
